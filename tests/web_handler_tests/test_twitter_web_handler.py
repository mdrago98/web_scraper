...
class TestTwitterSourceHandler(TestCase):
    ...
    test_twitter_url = 'https://twitter.com/i/profiles/show/google/timeline/tweets?' \
    ...
    def test_get_posts_parses_twitter_response(self):
        ...
        self.assertEqual(first_post, result[0].as_dict(), 'The expected result did not match')
